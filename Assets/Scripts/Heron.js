...
function Start()
{
	...
	leftKnee = myT.FindChild("Island/HeronAnimated/MasterMover/RootDummy/Root/Lhip/knee2");
	leftAnkle = leftKnee.FindChild("ankle2");
	leftFoot = leftAnkle.FindChild("foot2");
	rightKnee = myT.FindChild("Island/HeronAnimated/MasterMover/RootDummy/Root/Rhip/knee3");
