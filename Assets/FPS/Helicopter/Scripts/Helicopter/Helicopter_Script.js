...
private var 	rotor_Velocity 						: float = 0.50;			// value between 0 and 1
private var 	rotor_Rotation 						: float = 0.10; 			// degrees... used for animating rotors

var 			max_tail_Rotor_Force 				: float = 15000.0; 		// newtons
var 			max_Tail_Rotor_Velocity 			: float = 2200.0; 		// degrees per second
private var 	tail_Rotor_Velocity 				: float = 0.50; 			// value between 0 and 1
private var 	tail_Rotor_Rotation 				: float = 0.10; 			// degrees... used for animating rotors
...
function FixedUpdate () {
	...
	var controlTorque : Vector3 = Vector3( 0 * forward_Rotor_Torque_Multiplier, 1.0, -0 * sideways_Rotor_Torque_Multiplier );
